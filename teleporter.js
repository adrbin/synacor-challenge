"use strict";
let reg8000 = 4, reg8001 = 1, reg8007 = 0;
...
function verificationOptimized(reg8007, memo) {
...
function setMemo(memo, initialRegPair, resultRegPair) {
...
var Position;
(function (Position) {
    Position[Position["Position0"] = 0] = "Position0";
    Position[Position["Position1"] = 1] = "Position1";
    Position[Position["Position2"] = 2] = "Position2";
    Position[Position["Position3"] = 3] = "Position3";
    Position[Position["Position4"] = 4] = "Position4";
})(Position || (Position = {}));
function verificationOptimized2(reg8007) {
    const regPair = {
        reg8000: 4,
        reg8001: 1,
    };
    ...
    while (callRecord !== undefined) {
        switch (callRecord.position) {
            case Position.Position0:
                ...
                callRecord.initialRegPair = Object.assign({}, regPair);
